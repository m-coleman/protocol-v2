...
export type iMaticPoolAssets<T> = Pick<iAssetsWithoutUSD<T>, 'USDe'>;

export type iXDAIPoolAssets<T> = Pick<iAssetsWithoutUSD<T>, 'USDe'>;
export type iAvalanchePoolAssets<T> = Pick<iAssetsWithoutUSD<T>, 'USDe'>;
